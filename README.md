...
- Structure: &lt;modid:item\_name&gt; or PRESENT&lt;{NBT\_Tag}&gt;
- Example:
...
For more example and information, follow, official documentation: [https://pixelmonmod.com/wiki/Pokemon_spec](https://pixelmonmod.com/wiki/Pokemon_spec)
